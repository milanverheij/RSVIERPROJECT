...
public class KlantDAOXML implements KlantDAO {
	...
	public long getKlantID(String voornaam, String achternaam, String email) throws GeneriekeFoutmelding {
		...
		ArrayList<Klant> klantenLijst = getKlantOpKlant(null);

		for(Klant tijdelijkeKlant : klantenLijst)
	...
	public ArrayList<Klant> getKlantOpKlant(Klant klant) throws GeneriekeFoutmelding {
		...
		Iterator<Klant> it = klantenDatabase.iterator();
		ArrayList<Klant> k = new ArrayList<Klant>();
				while(it.hasNext())
					k.add(it.next());
